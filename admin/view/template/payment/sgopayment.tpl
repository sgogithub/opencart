        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        <td><?php echo $entry_transaction_fee_danamon_atm; ?></td>
                        <td><input type="text" name="sgopayment_transaction_fee_danamon_atm" value="<?php echo $sgopayment_transaction_fee_danamon_atm; ?>" /></td>
                    </tr>
                    <tr>
