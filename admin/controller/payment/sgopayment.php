...
class ControllerPaymentSgopayment extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['sgopayment_transaction_fee_danamon_atm'])) {
            $this->data['sgopayment_transaction_fee_danamon_atm'] = $this->request->post['sgopayment_transaction_fee_danamon_atm'];
        } else {
        ...
        $this->data['entry_transaction_fee_danamon_atm'] = $this->language->get('entry_transaction_fee_danamon_atm');
